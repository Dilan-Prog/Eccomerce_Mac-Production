...
class ShippingRuleDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            ...
            $deleteBtn = "<a href='".route('admin.shipping-rule.destroy',$query->id)."' class='btn btn-danger m-2 delete-item'>Delete</a>";
            return $editBtn.$deleteBtn;
        })
        ->addColumn('type',function($query){
            if($query->type == 'min_cost'){
                return '<i class="badge badge-success">Cantidad mínima de pedido</i>';
            }else{
                return '<i class="badge badge-primary">Costo fijo</i>';
            }
        })
