    ...
    @section('title')
    {{$settings->site_name}} || Iniciar Seci&oacute;n
                ...
                <div class="col-xl-5 m-auto">
                    <div class="wsus__login_reg_area">
                        ...
                        <div class="tab-content" id="pills-tabContent2">
                            <div class="tab-pane fade " id="pills-homes" role="tabpanel" aria-labelledby="pills-home-tab2">
                                ...
                                <div class="wsus__login">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="wsus__login_input">
                                            ...
                                            <input type="email" id="email" value="{{old('email')}}" placeholder="Correo Electronico" name="email">
                                        </div>
                                        ...
                                        <div class="wsus__login_save">
                                            ...
                                            <a class="forget_p" href="{{ route('password.request') }}">Recordar Contraseña</a>
                                        </div>
                            ...
                            <div class="tab-pane fade show active" id="pills-profiles" role="tabpanel"
                                ...
                                <div class="wsus__login">
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="wsus__login_input">
                                            <i class="fas fa-user-tie"></i>
                                            <input type="text" placeholder="Nombre" id="name" value="{{old('name')}}" name="name">
                                        </div>
                                        <div class="wsus__login_input">
                                        ...
                                        <div class="wsus__login_input">
                                            <i class="fas fa-key"></i>
                                            <input name="password_confirmation" id="password_confirmation" type="password" placeholder="Confirmar Contraseña">
                                        </div>
