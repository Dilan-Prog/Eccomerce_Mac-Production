...
@section('title', $settings->site_name . ' || Pedido Registrado')
    ...
    <div class="container">
        <div class="inner">
            ...
            <p style="font-size:15px;opacity:0.9;max-width:480px;margin:8px auto 0;">
                Tu pedido quedó registrado. Solo falta que realices la transferencia para que procesemos el envío.
            </p>
    ...
    <div class="container">
        ...
        <div class="email-banner">
            ...
            <div class="email-banner-content">
                <div class="email-banner-title">Incluye tu número de pedido en la referencia</div>
                <div class="email-banner-text">
                    Al hacer tu transferencia, usa <span class="email-banner-email">{{ $order->invocie_id }}</span>
                    como referencia — así podemos identificar tu pago y procesar tu pedido más rápido.
                </div>
            </div>
        </div>
        ...
        <div class="success-grid">
                    ...
                    <div class="success-card-body">
                        <div class="info-grid">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-value">🏦 Transferencia SPEI</div>
                            </div>
                            <div class="info-item">
                            ...
                            <div class="info-item">
                                <div class="info-label">Total a transferir</div>
                        ...
                        <div class="timeline">
                            <div class="timeline-step">
                                ...
                                <div class="timeline-content">
                                    <div class="timeline-title">Pedido registrado</div>
                            ...
                            <div class="timeline-step">
                                ...
                                <div class="timeline-content">
                                    <div class="timeline-title">Transferencia confirmada</div>
                                    <div class="timeline-desc">
                                        {{ $order->payment_status ? 'Recibimos tu transferencia correctamente.' : 'Esperando que realices la transferencia y confirmemos tu pago.' }}
                                    </div>
                                </div>
                            </div>
                            <div class="timeline-step">
            ...
            <div class="success-sidebar">
                ...
                <div class="success-actions">
                    <a href="{{ route('user.profile', ['tab' => 'orders']) }}" class="btn-success-primary">
