...
{{-- ============================================================================
     Landing pt-BR · Honeywell DC1010
     Plantilla de producto para el mercado de Brasil. Replica la estructura de
     honeywell-dc1040.blade.php sobre el layout propio de la sección Brasil
     (frontend.layouts.br): cabecera y pie en portugués, sin catálogo.
     ...
     Ángulo: el DC1010 es el formato más compacto de la serie (1/16 DIN,
     48 × 48 mm) para paneles con poco espacio y muchas zonas.
     ============================================================================ --}}

@php
    $br = config('brasil');
    $urlCanonica = route('br.honeywell-dc1010');
    $imagenPrincipal = $imagenes->first() ?? 'https://www.macdelnorte.com/uploads/media_66c113b85c43f.control de temperatura dc1010ct-101000-e_1.webp';
@endphp

@section('title', 'DC1010 Honeywell | Controlador de Temperatura 1/16 DIN')

@section('meta_description', 'Honeywell DC1010, controlador de temperatura 1/16 DIN (48 x 48 mm) com entrada universal e PID. Distribuidor autorizado. Solicite orçamento pelo WhatsApp.')

@section('social_meta')
    <meta property="og:type" content="product">
    <meta property="og:title" content="DC1010 Honeywell | Controlador de Temperatura 1/16 DIN">
    <meta property="og:description" content="Controlador compacto 1/16 DIN (48 × 48 mm) com entrada universal e PID auto-sintonizado. Distribuidor autorizado Honeywell. Orçamento e prazo de entrega para o Brasil.">
    <meta property="og:image" content="{{ $imagenPrincipal }}">
    <meta property="og:url" content="{{ $urlCanonica }}">
    <meta property="og:locale" content="pt_BR">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="DC1010 Honeywell | Controlador de Temperatura 1/16 DIN">
    <meta name="twitter:description" content="Controlador compacto 1/16 DIN com entrada universal e PID auto-sintonizado. Distribuidor autorizado Honeywell.">
      ...
      "@graph": [
        {
          ...
          "name": "Honeywell DC1010 Controlador de Temperatura 1/16 DIN",
          "sku": "DC1010",
          "mpn": "DC1010",
          ...
          "description": "Controlador compacto 1/16 DIN (48 x 48 mm) com entrada universal (termopar, RTD, mV, mA) e controle PID com auto-sintonia.",
          "additionalProperty": [
            { "@type": "PropertyValue", "name": "Entrada", "value": "Universal (termopar, RTD, mV, mA)" },
            { "@type": "PropertyValue", "name": "Alimentação", "value": "90-264 VAC" },
            { "@type": "PropertyValue", "name": "Formato", "value": "1/16 DIN, 48 x 48 mm" }
          ],
          "offers": {
            "@type": "Offer",
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Honeywell DC1010", "item": "{{ $urlCanonica }}" }
          ]
        },
        {
          "@type": "FAQPage",
          "mainEntity": [
            ...
            { "@type": "Question", "name": "Vocês ajudam a escolher entre os modelos da série DC1000?", "acceptedAnswer": { "@type": "Answer", "text": "Sim. Informe a grandeza medida, o tipo de sensor, o número de zonas e o espaço disponível no painel; indicamos o formato (1/16, 1/8 ou 1/4 DIN) e o tipo de saída mais adequado." } }
          ]
        }
      ]
    }
...
<div class="br-landing">
    ...
    <nav class="br-crumbs" aria-label="Trilha">
        <div class="br-wrap">
            ...
            <span class="cur">Honeywell DC1010</span>
        </div>
    </nav>
        ...
        <div class="br-hero">
            <div>
                <div class="br-tags">
                    ...
                    <span class="br-tag br-tag--sku">SKU: DC1010 · série DC1000</span>
                </div>
                <h1>Honeywell DC1010 — Controlador de Temperatura 1/16 DIN</h1>
                <p class="br-lead">O formato mais compacto da série DC1000: entrada universal e controle PID com auto-sintonia em um painel de 48 × 48 mm, ideal para painéis com pouco espaço e máquinas com muitas zonas de aquecimento.</p>
                <ul class="br-bullets">
                    <li>Formato 1/16 DIN (48 × 48 mm): mais zonas de controle no mesmo painel</li>
                    <li>Entrada universal: um só modelo cobre termopar, RTD, mV e mA</li>
                    <li>Saída por relé, SSR (pulso de tensão) ou 4–20 mA, conforme o código de pedido</li>
                    <li>Auto-sintonia PID e alimentação ampla 90–264 VAC, sem transformador adicional</li>
                </ul>
                <div class="br-ctas">
                    <a href="{{ $br['whatsapp'] }}" target="_blank" rel="noopener" class="br-wa track-conversion" data-type="whatsapp_br_dc1010_hero">
            ...
            {{-- Galeria: fotos reales del catalogo (portada + galeria de cada
                 codigo de pedido DC1010). Las miniaturas cambian la principal. --}}
            <div class="br-gallery">
                <div class="br-gallery-main">
                    <img id="br-img-principal" src="{{ $imagenPrincipal }}"
                         alt="Honeywell DC1010, controlador de temperatura 1/16 DIN" width="520" height="340">
                </div>
                @if($imagenes->count() > 1)
                <div class="br-thumbs" role="list">
                    @foreach($imagenes as $i => $img)
                        <button type="button" class="br-thumb {{ $i === 0 ? 'is-active' : '' }}" data-src="{{ $img }}" role="listitem" aria-label="Foto {{ $i + 1 }} do Honeywell DC1010">
    ...
    <div class="br-wrap">
        ...
        <section class="br-section" id="especificacoes">
            ...
            <div class="br-specs">
                <table>
                    <tbody>
                        <tr><th scope="row">Tipo de produto</th><td>Controlador de temperatura/processo 1/16 DIN</td></tr>
                        <tr><th scope="row">Entrada</th><td>Universal — termopar, RTD, mV, mA</td></tr>
                        <tr><th scope="row">Saída de controle</th><td>Relé, SSR (pulso de tensão) ou 4–20 mA, conforme o código de pedido</td></tr>
                ...
                <table>
                    <tbody>
                        ...
                        <tr><th scope="row">Dimensão do painel</th><td>48 × 48 mm (1/16 DIN)</td></tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="br-codes">
                @foreach($codigos as $nombre)
                    <span class="br-code">{{ \Illuminate\Support\Str::of($nombre)->replace('Control de temperatura ', '')->replace('Control De Temperatura ', '')->replace('Honeywell ', '') }}</span>
                @endforeach
            </div>
            @endif
        ...
        <section class="br-section" id="aplicacoes">
            ...
            <p class="br-sub">Onde o DC1010 costuma ser especificado: painéis compactos e máquinas com várias zonas de controle.</p>
            <div class="br-apps">
                <div class="br-app"><span class="br-app-ico" aria-hidden="true">A</span><h3>Extrusoras multizona</h3><p>Um controlador por zona de aquecimento, lado a lado, em linhas de extrusão de plásticos.</p></div>
                <div class="br-app"><span class="br-app-ico" aria-hidden="true">B</span><h3>Fornos de pequeno porte</h3><p>Controle de setpoint em fornos de bancada e câmaras de tratamento térmico compactas.</p></div>
                <div class="br-app"><span class="br-app-ico" aria-hidden="true">C</span><h3>Estufas de secagem</h3><p>Secagem e cura em estufas industriais e de laboratório com espaço reduzido de painel.</p></div>
                <div class="br-app"><span class="br-app-ico" aria-hidden="true">D</span><h3>Máquinas de embalagem</h3><p>Controle de temperatura de mordentes e barras de selagem em seladoras e envasadoras.</p></div>
                <div class="br-app"><span class="br-app-ico" aria-hidden="true">E</span><h3>Equipamentos de laboratório</h3><p>Banhos, incubadoras e blocos de aquecimento com painel frontal compacto.</p></div>
                <div class="br-app"><span class="br-app-ico" aria-hidden="true">F</span><h3>Injetoras e moldes</h3><p>Controle de zonas de aquecimento em injetoras e canais quentes com muitos pontos no mesmo painel.</p></div>
            </div>
        </section>
                ...
                <table class="br-xref">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Relação com o DC1010</th>
                            <th scope="col">Observação</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr><th scope="row"><a href="{{ route('br.honeywell-dc1040') }}">DC1040</a></th><td class="fab">Honeywell</td><td>Mesma série, formato 1/4 DIN</td><td class="obs">Alternativa de maior formato; recorte de painel diferente</td></tr>
                        ...
                        <tr><th scope="row"><a href="{{ route('br.honeywell-dc1200') }}">DC1200</a></th><td class="fab">Honeywell</td><td>Série superior, formato 1/8 DIN</td><td class="obs">Confirmar paridade de funções e recorte de painel para a aplicação</td></tr>
        ...
        <section class="br-section" id="ficha">
            <div class="br-sheet">
                ...
                <div class="br-sheet-cta">
                    <a href="{{ $br['whatsapp'] }}" target="_blank" rel="noopener" class="br-wa br-wa--sm track-conversion" data-type="whatsapp_br_dc1010_ficha">
                        @include('frontend.layouts.br.icon-whatsapp')
            ...
            <div class="br-faq">
                ...
                <div class="br-faq-list">
                    ...
                    <details>
                        ...
                        <p>Sim. Informe a grandeza medida, o tipo de sensor, o número de zonas e o espaço disponível no painel; indicamos o formato (1/16, 1/8 ou 1/4 DIN) e o tipo de saída mais adequado, com as alternativas equivalentes. Se o painel for apertado ou houver muitas zonas, o DC1010 costuma ser o ponto de partida.</p>
                    </details>
                </div>
            </div>
        </section>
    ...
    <section class="br-quote" id="orcamento">
        <div class="br-wrap">
            <div class="br-quote-grid">
                <div>
                    <h2>Solicitar orçamento do DC1010</h2>
                ...
                <div class="br-quote-side">
                    <a href="{{ $br['whatsapp'] }}" target="_blank" rel="noopener" class="br-wa track-conversion" data-type="whatsapp_br_dc1010_orcamento">
                        @include('frontend.layouts.br.icon-whatsapp')
                        Falar no WhatsApp
                    </a>
    ...
    <div class="br-sticky">
        <a href="{{ $br['whatsapp'] }}" target="_blank" rel="noopener" class="br-wa track-conversion" data-type="whatsapp_br_dc1010_sticky">
            @include('frontend.layouts.br.icon-whatsapp')
            Solicitar orçamento pelo WhatsApp
        </a>
    </div>
