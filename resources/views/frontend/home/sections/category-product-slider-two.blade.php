<section id="wsus__electronic2" style="padding-top: 10px; background: white;">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
        ...
        <div class="cps-carousel" id="wsus__electronic2_slider-two">
            <button type="button" class="cps-arrow cps-arrow--prev" aria-label="Anterior">
                <i class="fas fa-chevron-left"></i>
            </button>

            <div class="cps-track">
            @foreach ($categoryProductsSectionsTwo as $product)
                @php
...
<script>
    (function () {
        document.querySelectorAll('#wsus__electronic2_slider-two').forEach(function (carousel) {
