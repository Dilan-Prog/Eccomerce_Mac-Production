$(function () {
    ...
    // Evento para mostrar/ocultar el menú al hacer clic en la barra de menú
    ...
    $(document).on('click', function(event) {
        // Si el clic ocurrió dentro del menú o en la barra de menú, no hacer nada
        if ($(event.target).closest('.wsus_menu_category_bar').length || 
            $(event.target).closest('.toggle_menu').length) {
            return;
        }
        // Si el clic ocurrió fuera del menú, remover la clase 'show_category'
        if ($('.toggle_menu').hasClass('.show_category')) {
            $('.toggle_menu').removeClass('.show_category');
        }
    });
